...
const Login = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute top-[-20%] left-[-10%] w-96 h-96 bg-premium-accent/5 rounded-full blur-3xl"></div>
      ...
      >
        <div>
          <h2 className="mt-6 text-center text-3xl font-serif text-premium-dark">Welcome Back</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute inset-y-0 right-0 pr-3 flex items-center text-premium-dark/40 hover:text-premium-dark transition-colors z-20"
        ...
        <div className="text-center mt-4">
          <Link to="/signup" className="text-sm text-premium-brown hover:text-premium-accent transition-colors">
